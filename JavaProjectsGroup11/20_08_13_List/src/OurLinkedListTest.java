...
class OurLinkedListTest {
    ...
    @Test
    void testAdd_oneT_size1_equalTo() {
        list.add(5);
    ...
    void testAdd_onePoint_containsExistingPoint() {
        OurList<Point2D> pointList = new OurLinkedList<>();
    ...
    @Test
    void testAdd_threeDifferentT_size3_equalTo() {
        list.add(16);
        list.add(5);
        list.add(0);
    ...
    @Test
    void testAdd_1to100T_size100_equalTo() {
        for (int i = 0; i < 100; i++) {
            list.add(i);
        }
    ...
    @Test
    void testRemoveIndex_oneT_size0() {
        list.add(1);
